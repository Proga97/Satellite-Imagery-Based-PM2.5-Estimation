...
def parse_pixels(arr: np.ndarray, bands: list[str]) -> tuple[np.ndarray, float, int]:
    """structured array from computePixels -> (H,W,3) uint16, valid_fraction, n_images."""
    ...
    return rgb, valid_fraction, n_images
